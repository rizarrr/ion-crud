...
export class Tab3Page {
  ...
  async getData() {
    ...
    try {
      const res = await axios.post('http://localhost/api-crud/api/get_data_mahasiswaId.php', fd);
      ...
      for (let data of this.mahasiswaData) {
        ...
        this.foto_siswa = data.foto_mahasiswa;
      }
  ...
  async updateData() {
    ...
    try {
      const res = await axios.post('http://localhost/api-crud/api/update_data_mahasiswa.php', fd);
